        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden flex flex-col min-h-[500px]">
          <div className="p-4 border-b border-gray-100 flex items-center justify-between bg-gray-50/50">
            <div className="relative">
              ...
              <input type="text" placeholder="Search users..." className="pl-9 pr-4 py-2 border border-gray-200 rounded-lg text-sm w-64 focus:outline-none focus:ring-1 focus:ring-blue-500 bg-white" />
            </div>
          ...
          <div className="flex-1 flex flex-col items-center justify-center text-gray-400">
            ...
            <p className="text-lg font-medium text-gray-600">User management coming soon</p>
            <p className="text-sm mt-1">This section will allow you to moderate candidates and employers.</p>
          </div>
        </div>
      </div>
    </AdminLayout>
